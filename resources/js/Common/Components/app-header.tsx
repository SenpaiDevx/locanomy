...
import CompostTwoToneIcon from '@mui/icons-material/CompostTwoTone';
...
import { Sheet, SheetContent, SheetHeader, SheetTitle, SheetTrigger } from '@/Common/Components/ui/sheet';
...
import { cn, toUrl } from '@/Common/Lib/utils';
import type { BreadcrumbItem, NavItem } from '@/Common/Types';
                ...
                <div className="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                    ...
                    <div className="lg:hidden">
                        <Sheet>
                            <SheetTrigger asChild>
                                ...
                                >
                                    <MenuRoundedIcon style={{ height: '20px', width: '20px' }} />
                                </Button>
                            </SheetTrigger>
                            <SheetContent
                                side="left"
                    ...
                    <div className="ml-auto flex items-center space-x-2">
                        <div className="relative flex items-center space-x-1">
                            ...
                            >
                                <div className='size-5! opacity-80 group-hover:opacity-100'>
                                    <SearchRoundedIcon />
                                </div>
                            </Button>
